 ...
 * Generated: 2026-07-29T00:42:12.832Z
 */

/**
 * otepad theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { otepadTheme } from './otepad';
 *   import './otepad.css';
 */
export const otepadTheme = {
  name: 'otepad',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "Fraunces, \"Iowan Old Style\", \"Palatino Linotype\", Palatino, Georgia, serif",
    "--font-family-heading": "Fraunces, \"Iowan Old Style\", \"Palatino Linotype\", Palatino, Georgia, serif",
    "--font-family-code": "\"IBM Plex Mono\", \"Lucida Console\", monaco, \"Bitstream Vera Sans Mono\", monospace",
    ...
    "--color-background-surface": "light-dark(#F1FFFD, #131D1C)",
    "--color-background-body": "light-dark(#E6F4F1, #051311)",
    "--color-background-card": "light-dark(#F1FFFD, #131D1C)",
    "--color-background-popover": "light-dark(#F1FFFD, #283231)",
    "--color-background-muted": "light-dark(#131D1C0D, #131D1C80)",
    "--color-accent": "light-dark(#286860, #68e0c8)",
    "--color-accent-muted": "light-dark(#e6f5f2, #1a3330)",
    "--color-neutral": "light-dark(#131D1C1A, #D8E5E333)",
    "--color-overlay": "light-dark(#131D1C66, #131D1C99)",
    "--color-overlay-hover": "light-dark(#131D1C0D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#131D1C1A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#131D1C, #D8E5E3)",
    "--color-text-secondary": "light-dark(#384A47, #9BB0AC)",
    "--color-text-disabled": "light-dark(#809591, #4F625F)",
    "--color-text-accent": "light-dark(#286860, #90f8e8)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#ffffff, #0a1f1c)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#286860, #90f8e8)",
    "--color-icon-primary": "light-dark(#131D1C, #D8E5E3)",
    "--color-icon-secondary": "light-dark(#384A47, #9BB0AC)",
    "--color-icon-disabled": "light-dark(#809591, #4F625F)",
    ...
    "--color-border": "light-dark(#131D1C1A, #E6F4F11A)",
    "--color-border-emphasized": "light-dark(#9BB0AC, #384A47)",
    "--color-skeleton": "light-dark(#9BB0AC, #384A47)",
    ...
    "--color-background-inverted": "light-dark(#131D1C, #F1FFFD)",
    "--color-track": "light-dark(#9BB0AC, #384A47)"
  },
